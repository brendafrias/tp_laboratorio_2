...
namespace EntidadesInstansiables
{
    public class Universidad
    {
        ...
        /// <summary>
        /// Propiedad Alumnos asigna un valor al atributo alumnos, o retorna su contenido.
        /// </summary>
        public List<Alumno> Alumnos { get { return this.alumnos; } set { this.alumnos = value; } }

        /// <summary>
        /// Propiedad Instructores asigna un valor al atributo profesores, o retorna su contenido.
        /// </summary>
        public List<Profesor> Instructores { get { return this.profesores; } set { this.profesores = value; } }

        /// <summary>
        /// Propiedad Jornadas asigna un valor al atributo jornada, o retorna su contenido.
        /// </summary>
        ...
        /// <returns>Retorna una <see cref="Universidad"/> con el <see cref="Alumno"/> agregado. 
        /// Si el Alumno esta repetido y no fue posible agregarlo, se lanza <see cref="AlumnoRepetidoException"/>.</returns>
